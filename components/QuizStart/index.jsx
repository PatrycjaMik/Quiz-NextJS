    ...
    <section className='relative bg-black aspect-[320/867] h-full'>
        ...
        <div className= 'pt-28 z-10'>
            ...
            <div className="w-[80%] m-auto mt-[5%]">
              ...
              <SideBorderBox containerClass="h-[550px]">
                ...
                <div className="border-b-[1px] border-black w-[80%] p-1 m-auto mt-8 ">
                  <p className=" text-[24px] font-bold font-oswald text-center pb-8">Podaj dane by rozpocząć quiz.</p>
                </div>
             ...
             <div>
              ...
              type="text"
              required
              className=" p-4 bg-black text-center placeholder:text-white font-oswald text-[24px] w-full border-b-[1px] border-primary"
              {...register("UserName", {
                required: true,
              })}
            />
            ...
            <input
              ...
              id="Email"
              type="email"
              className="p-2 bg-black text-center placeholder:text-white font-oswald text-[24px] w-full "
              {...register("Email", {
                required: true,
              })}
            />
        ...
        <div className="absolute absolute bottom-0 left-0 w-10/12 h-1/5">
