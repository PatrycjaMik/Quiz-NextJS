...
export default function VotedAlready() {
  return (
        ...
        <SideBorderBox containerClass=" h-[550px] z-10 max-w-screen-md md:m-auto">
          <div className="flex justify-center items-center h-full">
            <div className="border-b-[1px] border-t-[1px] border-black w-[80%] p-4 ">
              <p className=" text-[30px] font-bold font-oswald text-center  p-4 ">
                Twój głos został już oddany. Nie możesz przystąpić do quizu
                ponownie
              </p>
            </div>
          </div>
